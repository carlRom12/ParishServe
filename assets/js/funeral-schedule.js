(function () {
    ...
    if (prevLink) prevLink.href = 'funeral-schedule.html?month=' + (prevMonth.getMonth() + 1) + '&year=' + prevMonth.getFullYear();
    if (nextLink) nextLink.href = 'funeral-schedule.html?month=' + (nextMonth.getMonth() + 1) + '&year=' + nextMonth.getFullYear();

    // Sample funeral arrangements shown on the 6th/13th/20th/27th
    ...
    const sampleEvents = [
        { day: 6, category: 'orientation', title: 'Office Coordination', time: '9:00 AM - 10:00 AM', location: 'Parish Office' },
        { day: 13, category: 'recollection', title: 'Document Review', time: '10:00 AM - 11:00 AM', location: 'Parish Office' },
        { day: 20, category: 'mass', title: 'Funeral Mass Request', time: '2:00 PM - 3:00 PM', location: 'Parish Church' },
        { day: 27, category: 'other', title: 'Burial Coordination', time: '9:00 AM - 10:00 AM', location: 'Family-arranged location' },
    ];
    ...
    if (listView) {
        ...
        if (monthEvents.length === 0) {
            ...
            empty.textContent = 'No scheduled funeral arrangements for this month yet.';
    ...
    const upcoming = document.getElementById('funeralUpcoming');
    ...
    viewButtons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            if (view === 'today') {
                window.location.href = 'funeral-schedule.html';
                return;
            }
